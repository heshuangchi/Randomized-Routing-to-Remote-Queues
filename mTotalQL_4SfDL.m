function totalQL = mTotalQL_4SfDL(lambda, mu, delay, Chi,...
...
for jj = 1:SampleSize
    ...
    parfor ii = 1:length(Chi)
        [mQL1, mQL2, mQL3, mQL4] = RJSQ_mQL_4SfDL_mex(delay, Chi(ii), TimeHorizon, ArrTimes, ServiceTimes, RandomRoutes);
...
totalQL = (cumQL1 + cumQL2 + cumQL3 + cumQL4)/SampleSize;
end
